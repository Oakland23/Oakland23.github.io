...
**Tools Used:** Data cleansing, text formatting, date splitting, pivot tables, pivot charts, pivot charts analyse, field list, field buttons, chart elements, chart style, chart colour, percentage difference from, rank, sort, value filters, and slicer.
